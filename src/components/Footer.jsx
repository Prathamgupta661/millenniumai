...
const Footer = () => (
  <footer className="w-full bg-gradient-to-r from-cyan-500 to-pink-500 text-white mt-20">
    <div className="max-w-6xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6">
      <div className="flex flex-col items-center md:items-start">
        <span className="font-bold text-2xl font-dm tracking-wide mb-2">MillenniumAi</span>
